...
class _AssemblageTreeScreenState extends State<AssemblageTreeScreen> {
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Aucune image', style: TextStyle(color: Colors.grey[600], fontSize: 13)),
                  ],
                ),
              ),
            ),
        ...
        children: [
          if (hasCompImage)
            ...
            Container(
              ...
              child: const Icon(Icons.build, size: 24, color: AppColors.navy),
            ),
                  ...
                  if (hasComps) ...[
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(Icons.build, size: 10, color: AppColors.orange),
                          const SizedBox(width: 4),
                          Text(
                            '${child.composants!.length} comp.',
                            style: const TextStyle(
                              fontSize: 10, 
                              color: AppColors.orange, 
                              fontWeight: FontWeight.bold
  ...
  // ✅ NOUVELLE MÉTHODE : Affiche les détails du sous-assemblage cliqué
...
// ═══════════════════════════════════════════════════════════
// Widget Image Sécurisé (URL pré-signée MinIO)
// ═══════════════════════════════════════════════════════════
